...
// iClock Attendance Test
Route::get('/att', ['as'=>'dashboard.attendance.testnothing','uses'=>'AttendanceController@testNothing']);
Route::get('/att/iclock', ['as'=>'dashboard.attendance.test','uses'=>'AttendanceController@test']);
