...
@section('title')
    IIT Alumni | Exexutive Committee
@endsection
          ...
          <div class="container">
              <div class="row">
                  <div class="col-lg-8 col-md-7 col-sm-12 wow fadeInUp" data-wow-duration="300ms">
                      <!-- page title -->
                      <h1 class="black-text">Exexutive Committee...</h1>
                      <!-- end page title -->
                  </div>
              ...
              <div class="row margin-six">
                <div class="col-md-8 col-md-offset-2">
                  <center>
                    ...
                    <h1 class="margin-ten no-margin-bottom">Executive Committee Members will be elected by Direct Vote</h1>
                    <p class="text-med margin-ten width-80 center-col">After the successfull election of Executive committee, the list of committee will be available here!</p>
                  </center>
                </div>
